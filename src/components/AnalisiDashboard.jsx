  ...
  return (
    <div style={{ background: 'rgba(255,252,247,0.97)', borderRadius: 'var(--r-l)', padding: '18px 20px', flex: 1, minWidth: 120, boxShadow: 'var(--shadow-s)', border: '1px solid var(--border)' }}>
      <div style={{ fontSize: 22, marginBottom: 6 }}>{emoji}</div>
           <div style={{ fontFamily: 'var(--ff-body)', fontVariantNumeric: 'tabular-nums', fontSize: 30, fontWeight: 600, color: color||'var(--text)', lineHeight: 1 }}>{val}</div>
          ...
          <Card key={k} title={`📅 ${monthLabel(k)}`}>
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
              <div style={{ flex: 1, minWidth: 90, background: 'var(--surface-2)', borderRadius: 10, padding: '10px 14px', textAlign: 'center' }}>
                               <div style={{ fontSize: 20, fontWeight: 600, fontFamily: 'var(--ff-body)', fontVariantNumeric: 'tabular-nums' }}>€{m.ricavi.toFixed(2)}</div>
                <div style={{ fontSize: 11, color: 'var(--text-3)' }}>Ricavi</div>
              </div>
              <div style={{ flex: 1, minWidth: 90, background: 'var(--surface-2)', borderRadius: 10, padding: '10px 14px', textAlign: 'center' }}>
                               <div style={{ fontSize: 20, fontWeight: 600, fontFamily: 'var(--ff-body)', fontVariantNumeric: 'tabular-nums' }}>€{m.costi.toFixed(2)}</div>
              ...
              <div style={{ flex: 1, minWidth: 90, background: marg>=0?'#4a8e4a18':'#c04a4a18', borderRadius: 10, padding: '10px 14px', textAlign: 'center' }}>
                                <div style={{ fontSize: 20, fontWeight: 600, fontFamily: 'var(--ff-body)', fontVariantNumeric: 'tabular-nums', color: marg>=0?'#4a8e4a':'#c04a4a' }}>€{marg.toFixed(2)}</div>
